...
<h2 class="well"> Edit item info: </h2>
...
<div class="row">
	<div class="col col-md-8 col-md-offset-2">
		{!! Form::open(['files'=>true, 'route'=>['items.addImage',$item->id]]) !!}
		<div class="form-group {{$errors->has('image') ? ' has-error has-feedback' : ''}}">
			{!! Form::label('image', 'Add Image', ['class'=>'control-label sr-only']) !!}
			<div class="input-group">
				<span class="input-group-addon">Add Image</span>
				{!! Form::file('image', 
				['class' => 'form-control', 'placeholder'=>'Add Image', 'accept'=>'image/*']) !!}
	...
	<div class="col-md-3">
		<div class="thumbnail" style="height:295px">
			{{-- <a href="{{ url(Storage::url($image->path)) }}"> --}}
				...
				<div class="caption">
					{!! Form::open(['route'=>['items.deleteImage',$item->id, $image->id], 'method'=>'delete', 'class'=>'pull-bottom']) !!}
